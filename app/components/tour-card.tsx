    ...
    <div className='relative h-[28rem] border rounded-xl border-gray-200 overflow-hidden flex items-end'>
      ...
      <div className='relative bg-white max-h-full overflow-y-auto px-5 py-4 backdrop-blur-md flex flex-col w-full'>
        <div className="mb-0.5">
          <span className="text-xs capitalize px-2 py-0.5 rounded-full bg-primary text-white">{pkg.package_type}</span>
        </div>
        <div className="flex items-start justify-between">
          ...
          <button onClick={() => setIsExpanded(prev => !prev)} className='flex items-center gap-1 text-nowrap text-sm bg-gray-100 hover:bg-gray-200 py-1 px-2 rounded-md'>
