        ...
        <div>
            {data ? <StandardTable<CoaType>
                ...
                columns={[
                    ...
                    { key: 'actions', title: 'Actions', render: (row) => ( <Link href={`/admin-panel/COA/${row.id}`}><button className="px-2 py-1 text-sm text-white bg-red-500 rounded hover:bg-red-600">Edit </button></Link>)}
                ]}
            /> : (
